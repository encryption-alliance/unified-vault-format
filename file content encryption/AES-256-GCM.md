...
It uses an unsigned 32 bit integer to store the number of blocks `nBlocks` and the current block number `i` (resulting in a maximum file size of 140,617,229,238,300 bytes).
