...
* `firstSeed` (immutable): The ID of the initial seed (may be used for non-rotating keys)
* `latestSeed`: The ID of the seed used to derive keys for newly added files (changing it allows [key rotation](key-rotation.md))
